...
var ReactCreditCards = function (_React$Component) {
  ...
  _createClass(ReactCreditCards, [{
    ...
    value: function updateType(number) {
      ...
      var type = this.props.customCardsSupport ? this.props.checkCustomType(number) : null;
      type = type === null ? _payment2.default.fns.cardType(number) : type;

      var maxLength = this.props.customCardsSupport ? this.props.checkCustomMaxLength(number) : 16;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'rccs__card--front', style: this.props.customCardsStyles && this.props.customCardsStyles[this.issuer] ? this.props.customCardsStyles[this.issuer].div : null },
            _react2.default.createElement('div', { className: 'rccs__card__background', style: this.props.customCardsStyles && this.props.customCardsStyles[this.issuer] ? this.props.customCardsStyles[this.issuer].background : null }),
            _react2.default.createElement('div', { className: 'rccs__issuer', style: this.props.customCardsStyles && this.props.customCardsStyles[this.issuer] ? this.props.customCardsStyles[this.issuer].issuer : null }),
            _react2.default.createElement(
              'div',
              {
...
ReactCreditCards.propTypes = {
  ...
  checkCustomMaxLength: _propTypes2.default.func,
  checkCustomType: _propTypes2.default.func,
  customCardsStyles: _propTypes2.default.object,
  customCardsSupport: _propTypes2.default.bool,
