    ...
    <form onSubmit={NextStep}>
      ...
      {step === 2 && (
        <div className="FundingAmount">
          ...
          <main>
            ...
            <div className="FundingAmt">
              <label htmlFor="Vat" style={{ color: "#CD4729" }}>
                Vat (8%)
              </label>
              <input
                type="text"
      ...
      {step === 3 && (
        <div className="FundingAmount">
          ...
          <main>
            ...
            <div className="FundingAmt">
              <label htmlFor="txid" style={{ color: "#CD4729" }}>
                Enter your leverpay Transaction Code
              </label>
              <input
                type="text"
                name="txid"
      ...
      {step === 4 && (
        <div className="fundingSuccess">
          ...
          <strong>
            Please Kindly be patient as your payment will reflect in 5min. Thank
            you.
          </strong>
        </div>
      )}
